...
3. Library data lives in **Documents/Tonic** on desktop. On Android it defaults to `Android/data/…/files/Tonic` (or Documents/Tonic after All files access). Do not delete those files when upgrading.
