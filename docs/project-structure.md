...
`src/components/` holds viewer, import, library sidebar, setlists, live mode, editor, and metadata details. Do not add a router or client store ahead of later phases.
